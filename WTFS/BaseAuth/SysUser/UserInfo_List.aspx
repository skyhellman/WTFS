<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_List.aspx.cs" Inherits="WTFS.BaseAuth.SysUser.UserInfo_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="/App_Themes/Scripts/jquery.pullbox.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        //添加
        function add() {
            var url = "BaseAuth/SysUser/UserInfo_Form.aspx";
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "BaseAuth/SysUser/UserInfo_Form.aspx?key=" + key;
...
<body>
    ...
    <div class="btnbarcontetn">
        <div style="float: left;">
            ...
            style="background: url('../../App_Themes/images/Search.png') no-repeat scroll 0px 4px;">
