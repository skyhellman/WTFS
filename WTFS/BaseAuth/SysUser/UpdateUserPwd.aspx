<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUserPwd.aspx.cs" Inherits="WTFS.BaseAuth.SysUser.UpdateUserPwd" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="/App_Themes/Scripts/jquery.md5.js" type="text/javascript"></script>
    ...
    <style type="text/css">
        #errorMsg
        {
            ...
            padding-top: 3px;
            padding-bottom: 2px;
            background: rgb(255, 253, 215) url('/App_Themes/images/exclamation_octagon_fram.png') no-repeat scroll 5px 2px;
            color: red;
        }
    </style>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <tr>
            ...
            <td>
                ...
                <img src="/WebHandlers/VerifyCode.ashx" width="70" height="22" alt="点击切换验证码" title="点击切换验证码"
                    style="margin-top: 0px; vertical-align: top; cursor: pointer;" onclick="ToggleCode(this, '/WebHandlers/VerifyCode.ashx');return false;" />
            </td>
        </tr>
        <tr>
