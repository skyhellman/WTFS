<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroup_List.aspx.cs" Inherits="WTFS.BaseAuth.SysUserGroup.UserGroup_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/BaseAuth/SysUserGroup/UserGroup_Form.aspx?ParentId=" + UserGroup_ID;
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "/BaseAuth/SysUserGroup/UserGroup_Form.aspx?key=" + key;
        ...
        function Delete() {
            ...
            if (IsDelData(key)) {
                ...
                if (IsExist_Data('/WebHandlers/Common_Ajax.ashx', isExistparm) > 0) {
        ...
        function allotMember() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "/BaseAuth/SysUserGroup/UserGroupSet.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
        ...
        function allotAuthority() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "/BaseAuth/SysUserGroup/AllotAuthority_Form.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
                Urlhref(url);
            }
        }
        //详细信息
        function detail() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "/BaseAuth/SysUserGroup/UserGroup_Info.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
                Urlhref(url);
            }
        }
    </script>
