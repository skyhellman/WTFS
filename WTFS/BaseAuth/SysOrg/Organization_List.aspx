<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Organization_List.aspx.cs" Inherits="WTFS.BaseAuth.SysOrg.Organization_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/BaseAuth/SysOrg/Organization_Form.aspx?ParentId=" + Organization_ID;
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "/BaseAuth/SysOrg/Organization_Form.aspx?key=" + key;
