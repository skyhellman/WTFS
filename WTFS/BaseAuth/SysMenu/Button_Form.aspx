<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Button_Form.aspx.cs" Inherits="WTFS.BaseAuth.SysMenu.Button_Form" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function SelectOpenImg() {
            var url = "../BaseAuth/SysMenu/Icons_List.aspx?Size=16";
            top.openDialog(url, 'Icons_List', '系统图标 - 全取', 615, 400, 100, 100);
        }
        //全取图标回调赋值
        function Get_Menu_Img(img) {
            $("#Img_Button_Img").attr("src", '../../App_Themes/Images/16/' + img);
            $("#Button_Img").val(img);
        }
    </script>
</head>
       ...
       <table border="0" cellpadding="0" cellspacing="0" class="frm">
        ...
        <tr>
            ...
            <td>
                ...
                <img id="Img_Button_Img" src="/App_Themes/Images/illustration.png" runat="server" alt=""
                    style="vertical-align: middle; padding-right: 10px;" />
                <a href="javascript:void(0)" class="button green" onclick="SelectOpenImg()">图标选取</a>
            </td>
        </tr>
        <tr>
            <th>
