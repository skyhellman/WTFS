<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_List.aspx.cs" Inherits="WTFS.BaseAuth.SysMenu.Menu_List1" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/BaseAuth/SysMenu/Menu_Form.aspx?ParentId=" + Menu_Id;
        ...
        function edit() {
            var key = Menu_Id;
            if (IsEditdata(key)) {
                var url = "/BaseAuth/SysMenu/Menu_Form.aspx?key=" + key;
        ...
        function allotButton() {
            var key = Menu_Id;
            if (IsEditdata(key)) {
                var url = "/BaseAuth/SysMenu/AllotButton_Form.aspx?key=" + key;
