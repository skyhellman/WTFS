<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Button_List.aspx.cs" Inherits="WTFS.BaseAuth.SysMenu.Button_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function add() {
            var url = "/BaseAuth/SysMenu/Button_Form.aspx";
        ...
        function edit() {
            ...
            if (IsEditdata(CheckboxValue())) {
                var url = "/BaseAuth/SysMenu/Button_Form.aspx?key=" + key;
                ...
                <asp:Repeater ID="rp_Item" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 35px; text-align: center;">
                                <img src='/App_Themes/Images/16/<%#Eval("Button_Img")%>' style='width: 16px; height: 16px;
