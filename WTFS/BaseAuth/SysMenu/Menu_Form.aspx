<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_Form.aspx.cs" Inherits="WTFS.BaseAuth.SysMenu.Menu_Form" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function SelectOpenImg() {
            var url = "/BaseAuth/SysMenu/Icons_List.aspx?Size=32";
            top.openDialog(url, 'Icons_List', '系统图标 - 全取', 615, 400, 100, 100);
        }
        //全取图标
        function Get_Menu_Img(img) {
            $("#Img_Menu_Img").attr("src", '/App_Themes/Images/32/' + img);
            $("#Menu_Img").val(img);
        }
    </script>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <tr>
            ...
            <td>
                ...
                <img id="Img_Menu_Img" src="/App_Themes/Images/illustration.png" runat="server" alt=""
