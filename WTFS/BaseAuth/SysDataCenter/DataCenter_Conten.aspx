<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataCenter_Conten.aspx.cs" Inherits="WTFS.BaseAuth.SysDataCenter.DataCenter_Conten" %>
    ...
    <div class="btnbarcontetn">
        <div style="text-align: right;">
            <a href="javascript:void(0)" title="新建查询" onclick="addSQLQuery();" class="button green">
                <span class="icon-botton" style="background: url('/App_Themes/images/201208010567.png') no-repeat scroll 0px 4px;">
                </span>新建查询</a>
        </div>
    </div>
    <div class="div-body">
