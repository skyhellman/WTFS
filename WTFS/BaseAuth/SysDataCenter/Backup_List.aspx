<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Backup_List.aspx.cs" Inherits="WTFS.BaseAuth.SysDataCenter.Backup_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        //数据库备份
        function backups() {
            var url = "/BaseAuth/SysDataCenter/Backup_Confirm.aspx?type=0";
        ...
        function recover() {
            ...
            if (IsEditdata(CheckboxValue())) {
                if (arrt[0] == "备份") {
                    ...
                    var url = "/BaseAuth/SysDataCenter/Backup_Confirm.aspx?type=1";
