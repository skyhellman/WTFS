<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Backup_Confirm.aspx.cs" Inherits="WTFS.BaseAuth.SysDataCenter.Backup_Confirm" %>
...
<body>
    ...
    <div class="frmbottom">
        <a class="l-btn" href="javascript:void(0)" onclick="SaveForm();"><span class="l-btn-left">
            <img src="/App_Themes/Images/disk.png" alt="" />保 存</span></a> <a class="l-btn" href="javascript:void(0)"
