<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SQLQuery.aspx.cs" Inherits="WTFS.BaseAuth.SysDataCenter.SQLQuery" %>
    ...
    <div class="btnbarcontetn">
        ...
        <div style="text-align: right;">
            <asp:LinkButton ID="ExeOuter" runat="server" class="button green" OnClick="ExeOuter_Click"><span
                class="icon-botton" style="background: url('/App_Themes/images/lightning.png') no-repeat scroll 0px 4px;">
            </span>执 行</asp:LinkButton>
            <a href="javascript:void(0)" title="返 回" onclick="Back()" class="button green"><span
                class="icon-botton" style="background: url('/App_Themes/images/16/back.png') no-repeat scroll 0px 4px;">
            </span>返 回</a>
        </div>
    </div>
