<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Role_List.aspx.cs" Inherits="WTFS.BaseAuth.SysRole.Role_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="/App_Themes/Scripts/TreeTable/css/jquery.treeTable.css" rel="stylesheet"
        type="text/css" />
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/BaseAuth/SysRole/Role_Form.aspx?ParentId=" + Roles_ID;
        ...
        function edit() {
            var key = Roles_ID;
            if (IsEditdata(key)) {
                var url = "/BaseAuth/SysRole/Role_Form.aspx?key=" + key;
        ...
        function allotAuthority() {
            var key = Roles_ID;
            if (IsEditdata(key)) {
                var url = "/BaseAuth/SysRole/AllotAuthority_Form.aspx?key=" + key + '&Roles_Name=' + escape(Roles_Name);
                Urlhref(url);
            }
        }
        //详细信息
        function detail() {
            var key = Roles_ID;
            if (IsEditdata(key)) {
                var url = "/BaseAuth/SysRole/Role_Info.aspx?key=" + key + '&Roles_Name=' + escape(Roles_Name);
                Urlhref(url);
            }
        }
    </script>
