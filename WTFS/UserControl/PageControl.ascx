<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PageControl.ascx.cs" Inherits="WTFS.UserControl.PageControl" %>
<link href="/App_Themes/Styles/pagination.css" rel="stylesheet" type="text/css" />
<%--自定义用户分页控件--%>
